...
public class NotificationUtils {
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        PendingIntent pendingint = PendingIntent.getService(context,
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingint = PendingIntent.getService(context,
                ...
                intent,
                PendingIntent.FLAG_CANCEL_CURRENT);
        NotificationCompat.Action Incrementint = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,
                "Hello",
                pendingint);
        return Incrementint;
    }
