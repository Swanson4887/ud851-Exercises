...
public class MainActivity extends AppCompatActivity implements
    ...
    IntentFilter mChargingintFilter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChargingintFilter = new IntentFilter();
        mChargingintFilter.addAction(Intent.ACTION_POWER_CONNECTED);
        mChargingintFilter.addAction(Intent.ACTION_POWER_DISCONNECTED);
    ...
    protected void onResume() {
            super.onResume();
            registerReceiver(mChargingReciever, mChargingintFilter);
        }
